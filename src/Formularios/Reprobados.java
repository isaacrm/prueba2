 ...
 * @author Isaac
 */
public class Reprobados extends javax.swing.JDialog {

    /**
     * Creates new form Aprobados
     */
    public Reprobados(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("REPROBADOS EN MI MATERIA");
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Todos los Aprobados en esta Materia"));
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "NIE", "Nombres", "Apellidos", "Última Calificación", "Materia", "Usuario"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Reprobados dialog = new Reprobados(new javax.swing.JFrame(), true);
