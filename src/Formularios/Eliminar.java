...
public class Eliminar extends javax.swing.JDialog {
     ...
     */
    public Eliminar(javax.swing.JDialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void Eliminar()
    {
                   try
            {
                ...
                else
                {
                    ...
                    {
                        JOptionPane.showMessageDialog(this, "Usuario Eliminado. La aplicación se cerrará");
                        System.exit(0);
                    }
                    else
                    {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Eliminar dialog = new Eliminar(new javax.swing.JDialog(), true);
